# https://github.com/orpatashnik/local-prompt-mixing/blob/main/src/attention_based_segmentation.py 
import nltk
...
class SegmentorTorch:

    def __init__(self, num_segments=10, background_segment_threshold=0.5):
        self.num_segments = num_segments 
        self.background_segment_threshold = background_segment_threshold 
        self.model = torch_kmeans.KMeans(n_init=num_segments, n_clusters=num_segments)
