...
def calculate_positive_loss(attention_maps, modifier, noun, prior=None):
    ...
    if prior is not None:
        positive_loss += _symmetric_kl(attention_maps[noun], prior.to(attention_maps[noun].device))
